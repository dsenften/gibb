...
public class BaseRepositoryFactoryBean<R extends JpaRepository<T, I>, T, I extends Serializable> extends
    ...
    private static class BaseRepositoryFactory<T, I extends Serializable> extends JpaRepositoryFactory {
        ...
        @SuppressWarnings({"unchecked", "rawtypes", "hiding", "squid:S00119"})
        protected SimpleJpaRepository<T, I> getTargetRepository(RepositoryMetadata metadata, EntityManager entityManager) {
